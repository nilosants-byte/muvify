...
import { createManualBlockSchema } from "../validators/manual-block.validator";
...
manualBlockRoutes.post("/", validate(createManualBlockSchema), manualBlockController.create);
manualBlockRoutes.delete("/:blockId", manualBlockController.delete);
