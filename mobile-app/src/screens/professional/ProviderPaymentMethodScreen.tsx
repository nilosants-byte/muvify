...
// Raio-X de pagamentos, Rodada 4, Lote 6: cópia adaptada de
// ClientPaymentMethodScreen — o profissional agora também pode ter uma
// pendência (dívida gerada por disputa resolvida a favor do cliente) e
// precisa de um cartão próprio pra regularizá-la ativamente pela mesma rota
// de pagamento de dívida, generalizada em DebtService.payDebt.

type Props = NativeStackScreenProps<ProfessionalStackParamList, "ProviderPaymentMethod">;
...
export function ProviderPaymentMethodScreen({ navigation }: Props) {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: theme.bg }}>
      ...
      <View style={{ paddingTop: insets.top + 14, paddingHorizontal: S.px, paddingBottom: 10, flexDirection: "row", alignItems: "center", gap: 10, borderBottomWidth: 1, borderBottomColor: theme.border }}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={{ fontFamily: DISPLAY, fontWeight: "800", fontSize: 24, color: theme.text1, letterSpacing: -0.3 }}>Seu cartão</Text>
          <Text style={{ fontFamily: "DMSans_500Medium", fontSize: 11, color: theme.text3, marginTop: 2 }}>pra regularizar pendências</Text>
        </View>
      </View>
        ...
        <View style={{
          ...
          <Text style={{ fontFamily: "DMSans_400Regular", fontSize: 13, color: theme.text2, lineHeight: 20 }}>
            {configured
              ...
              : "Adicione um cartão pra poder pagar uma pendência ativamente, sem esperar o desconto no repasse."}
          </Text>
        </View>
